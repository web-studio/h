<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('min_amount')); ?>:</b>
	<?php echo CHtml::encode($data->min_amount); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('total_return')); ?>:</b>
	<?php echo CHtml::encode($data->total_return); ?>
	<br />
